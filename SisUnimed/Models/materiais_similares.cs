...
namespace SisUnimed.Models
{
    ...
    public partial class materiais_similares
    {
        [Key]
        [Display(Name="Código")]
        ...
        [Display(Name="Material Similar")]
        public long material_similar { get; set; }
        ...
        public virtual materiai materiai1 { get; set; }
    }
    public class ListaMatSimilar
    {
        public long id { get; set; }
        public string material_similar { get; set; }
